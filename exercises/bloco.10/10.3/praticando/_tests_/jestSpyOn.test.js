...
// /* Imagine que você queira testar a função `somar` implementando para ela um método de subtração, mas que depois você queira redefinir as implementações da simulação . */
